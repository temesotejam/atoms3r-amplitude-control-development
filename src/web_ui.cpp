...
<header><h1>Autonomous Energy Control V7</h1><div>V46am / 0.46.38 / V46al control retained / RWLOG download stability</div></header><main><p id="summary">Connecting...</p>
...
}function mark(id,yes){const e=document.getElementById(id);e.textContent=yes?'YES':'NO';e.className=yes?'yes':'no';}
