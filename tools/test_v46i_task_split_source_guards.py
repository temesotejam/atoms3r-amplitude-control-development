...
assert ('AtomS3R V46q MEKF Motor Validation' in manifest or
        ...
        'AtomS3R V46al Previous-Peak Active Control' in manifest or
        ...
        'AtomS3R V46aq V46al Download Restore' in manifest)
assert ('"version": "0.46.16"' in manifest or '"version": "0.46.35"' in manifest or
        '"version": "0.46.36"' in manifest or '"version": "0.46.37"' in manifest or '"version": "0.46.38"' in manifest or '"version": "0.46.39"' in manifest or '"version": "0.46.40"' in manifest or '"version": "0.46.42"' in manifest)
